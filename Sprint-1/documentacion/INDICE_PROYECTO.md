...
- Base de datos estructurada en CSV
- Programa Python interactivo
...
### 📊 1. DATOS
**Ubicación:** `datos/tienda_aurelion.csv`
- Base de datos con 20 productos
- 7 campos por producto (id, nombre, categoria, precio, stock, descripcion, proveedor)
- Formato CSV compatible con Python, Excel y Power BI

### 🐍 2. PROGRAMAS (3 VERSIONES)
