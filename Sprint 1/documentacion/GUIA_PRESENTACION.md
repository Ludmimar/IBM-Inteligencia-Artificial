...
**Qué decir:**
> "Buenos días/tardes. Mi nombre es [Ludmila Martos] y hoy les presentaré el proyecto Tienda Aurelion, un sistema de gestión de inventario desarrollado como parte del Sprint 1 de Introducción a la Inteligencia Artificial de IBM."
...
1. 📊 **Base de Datos**
   - Archivo CSV estructurado
   - 7 campos de información por producto
