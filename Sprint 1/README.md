...
**Sprint 1 - Introducción a la Inteligencia Artificial - IBM**
...
### Almacenamiento
Los datos se almacenan en formato **CSV (Comma-Separated Values)** en el archivo `tienda_aurelion.csv`, lo que permite:
...
La base de datos contiene **20 productos** organizados en **7 campos (columnas)**:

| Campo | Descripción | Ejemplo |
|-------|-------------|---------|
| **id** | Identificador único del producto | 1, 2, 3... |
| **nombre** | Nombre descriptivo del producto | "Espada Celestial" |
| **categoria** | Clasificación del tipo de producto | "Armas", "Pociones" |
| **precio** | Valor en monedas de oro | 1500 |
| **stock** | Cantidad disponible en inventario | 25 |
| **descripcion** | Descripción detallada del producto | "Espada forjada..." |
| **proveedor** | Nombre del proveedor | "Forja Celestial" |
...
#### Escala Actual
- **Registros totales**: 20 productos
- **Tamaño del archivo**: ~1.5 KB
- **Categorías**: 10 diferentes
- **Proveedores**: 9 diferentes
...
**Proyecto**: Sprint 1 - Introducción a la Inteligencia Artificial  
**Institución**: IBM  
...
- Documentación interactiva con Jupyter
...
| Archivo | Descripción |
|---------|-------------|
| `tienda_aurelion.csv` | Base de datos (20 productos) |

**📁 programas/:**
| Archivo | Descripción |
|---------|-------------|
| `tienda_aurelion.py` | Programa de consola Python |
| `app_streamlit.py` | Aplicación web Streamlit ⭐ |
| `tienda_aurelion.ipynb` | Jupyter Notebook interactivo |
| `crear_notebook.py` | Script auxiliar |
